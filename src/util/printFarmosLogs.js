...
const logTypes = [
  "asset--water", "asset--animal", "asset--equipment", "asset--plant",
  "asset--land", "asset--structure",
  "file--file", 
  "log--input", "log--observation", "log--maintenance", "log--activity",
  "log--harvest", "log--seeding",
  "quantity--material", "quantity--standard",
